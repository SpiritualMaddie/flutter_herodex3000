...
class FirestoreRepository {
  ...
  Future<void> saveAgent(AgentModel agent) async {
    try {
      ...
      debugPrint('❌ FirestoreRepository.saveAgent: $e\n$st');
  ...
  Future<void> deleteAgent(String agentId) async {
    try {
      ...
      debugPrint('❌ FirestoreRepository.removeAgent: $e\n$st');
  ...
  Future<List<AgentModel>> getAllSavedAgents() async {
    try {
      ...
      debugPrint('❌ FirestoreRepository.getAllSavedAgents: $e\n$st');
      return [];
    }
  }
  ...
  Future<bool> isAgentSaved(String agentId) async {
    try {
      ...
      debugPrint('❌ FirestoreRepository.isAgentSaved: $e\n$st');
      return false;
    }
  }
}